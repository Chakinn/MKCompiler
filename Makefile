...
HANDLINGELEMENTS = symbol memory_manager symbol_table node expression assignment condition branch branch_else while_do do_while write read code_block handler 
